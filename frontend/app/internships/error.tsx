...
export default function InternshipsError({
  error,
  reset,
}: {
  ...
  return (
    <div className="container-page py-16">
      <div className="mx-auto max-w-xl card p-8 text-center">
        ...
        <h1 className="mt-4 font-display text-2xl font-extrabold">Internships view failed</h1>
        <p className="mt-2 text-sm text-ink-500">
          We couldn&apos;t render this list. Try again or head home.
        </p>
