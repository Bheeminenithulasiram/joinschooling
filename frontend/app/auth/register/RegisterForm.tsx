...
type RoleType = "student" | "college_rep" | "recruiter" | "mentor";
...
export default function RegisterForm() {
  ...
  const handleGoogleSignIn = () => {
    ...
    // Fallback if SDK is still loading
    ...
    <div className="mt-5 flex flex-col gap-5">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
          ...
          >
            <Users size={17} className={selectedRole === "mentor" ? "text-brand-600" : "text-slate-400"} />
            <span>Mentor</span>
          </button>
        </div>
      </div>
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="input w-full rounded-xl border border-slate-200 bg-white px-3.5 py-2.5 text-sm text-ink-900 outline-none transition placeholder:text-slate-400 focus:border-brand-500 focus:ring-4 focus:ring-brand-100"
                  placeholder="Software Engineering & DSA"
                />
              </div>
              <div className="flex flex-col gap-1.5">
                <label className="block text-xs font-semibold text-slate-600">
